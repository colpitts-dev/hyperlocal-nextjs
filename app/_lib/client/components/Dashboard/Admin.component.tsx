...
import CardDataStats from '@hyperlocal/ui/components/CardDataStats'
    ...
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <Link href="/admin/people">
          <CardDataStats
            title="People"
            total={pageData?.totalPeople.toString()}
            rate="0.43%"
            levelUp
          >
            <svg
        ...
        <Link href="/admin/communities">
          <CardDataStats
            title="Communities"
            total={pageData.totalCommunities.toString()}
            rate="4.35%"
            levelUp
          >
            <svg
        ...
        <Link href="/admin/memberships">
          <CardDataStats
            title="Memberships"
            total={pageData.totalMemberships.toString()}
            rate="2.59%"
            levelUp
          >
            <svg
