...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      {/* <button
        disabled
        className="text-black dark:text-white flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50"
      >
        <span>
          <svg
            width="20"
      ...
      <div className="my-6 text-center text-black dark:text-white">
        <p>
