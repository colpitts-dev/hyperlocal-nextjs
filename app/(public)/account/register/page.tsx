        ...
        <div className="w-full border-stroke dark:border-strokedark">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form>
              ...
              <button
                disabled
                className="flex w-full cursor-not-allowed items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4  dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50"
              >
                <span>
                  <svg
                    width="20"
