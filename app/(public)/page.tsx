      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Based on knowledge sharing and member engagement.
          </p>
        </Link>
        <Link
          href="#"
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Memberships grant access to communities and content.
          </p>
        </Link>
        <Link
          href="#"
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Sign in and pay for content using popular web3 wallets.
          </p>
        </Link>
        <Link
          href="#"
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Hyperlocal is an open source project. Learn more!
          </p>
        </Link>
      </div>
    </main>
